...
import {Row,Col,CardPanel,Table,Tabs,Tab} from 'react-materialize';
        ...
        <CardPanel>
            <Row>
                ...
                <Col s={12} l={12} m={12} style={{textAlign:"justify"}}>
                    <h5 className="green text-darken-1" style={{fontWeight:"bold"}}>Passo a passo para calcular o mínimo da função</h5>
                ...
                <Col s={11} l={11} m={11} offset={"s1 m1 l1"} style={{textAlign:"justify"}}>
                    <h6><p>
                        <span style={{fontWeight:"bold"}} className=" text-darken-1">Função:</span> é a função que você deseja minimizar. 
                    ...
                    <h6><p>
                        <span style={{fontWeight:"bold"}} className="green text-darken-1">x0:</span> é o ponto inicial. Deve ser escrito entre parênteses/colchetes e as componentes separadas por espaço em branco. Exemplo: (0  0).
                        <b>Use ponto para números com casas decimais.</b>
                    </p></h6>
                    <h6><p>
                        <span style={{fontWeight:"bold"}} className="green text-darken-1">ε:</span> é a precisão. Deve ser maior que zero. <b>Use vírgula para números com casas decimais.</b>
                    </p></h6>
                </Col>
                ...
                <Col s={12} l={12} m={12} style={{marginBottom: 30,textAlign:"justify"}}>
                    <h5 className="green text-darken-1" style={{fontWeight:"bold"}}>Sintaxes</h5>
                    <h6><p>Formatação correta para fazer uso de funções com seus devidos OPERARADORES. 
